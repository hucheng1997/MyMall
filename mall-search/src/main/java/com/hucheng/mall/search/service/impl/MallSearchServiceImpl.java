...
import com.hucheng.mall.search.feign.ProductFeignService;
import com.hucheng.mall.search.service.MallSearchService;
import com.hucheng.mall.search.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParam param) {
        ...
        try {
            //2、执行检索请求
            SearchResponse searchResponse = esRestClient.search(searchRequest, MallElasticSearchConfig.COMMON_OPTIONS);
            //3、分析响应数据，封装成我们需要的格式
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        //1.2.3 bool-filter attrs 按照指定的属性查
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
