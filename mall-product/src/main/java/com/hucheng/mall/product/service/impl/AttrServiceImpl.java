...
import com.hucheng.mall.product.dao.AttrAttrgroupRelationDao;
...
import com.hucheng.mall.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public List<AttrEntity> getRelationAttr(Long attrGroupId) {
        ...
        List<Long> attrIds = relationList.stream().map(relation -> relation.getAttrId()).collect(Collectors.toList());
